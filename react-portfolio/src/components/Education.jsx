...
export default function Education() {
  return (
    <section className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2 p-6 rounded-xl bg-neutral-50 dark:bg-white/[0.02] backdrop-blur-md border-[1.5px] dark:border border-neutral-200 dark:border-white/10 shadow-lg hover:bg-neutral-100 dark:hover:bg-white/[0.04] transition-colors">
