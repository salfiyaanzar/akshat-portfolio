  ...
  return (
    <section id="contact" className="flex flex-col gap-4">
      ...
      <form className="flex flex-col gap-4 mt-1">
        ...
        <button
          type="button"
          className="mt-2 self-start px-6 py-3 bg-neutral-900 dark:bg-white text-white dark:text-black font-medium rounded-xl hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-colors flex items-center gap-2.5 shadow-lg dark:shadow-[0_4px_20px_rgba(255,255,255,0.15)] text-lg"
        >
          Send Message
